...
import { ChevronDown, ChevronRight, Briefcase, MapPin, Factory, Users, DollarSign } from "lucide-react";
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto">
        <FilterSection icon={<Briefcase className="h-4 w-4" />} label="Job Titles" defaultOpen>
          <TagInput
        ...
        <FilterSection icon={<Users className="h-4 w-4" />} label="Company Size">
          <div className="flex gap-2 items-center">
            <Input
              ...
              onChange={(e) => update({ companySizeMin: e.target.value })}
              placeholder="Min"
              className="h-8 text-xs bg-background"
            />
            ...
            <Input
              ...
              onChange={(e) => update({ companySizeMax: e.target.value })}
              placeholder="Max"
              className="h-8 text-xs bg-background"
            />
          </div>
